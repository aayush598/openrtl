...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent OpenRTL from reading sensitive files",
  "Use {highlight}openrtl run{/highlight} for non-interactive scripting",
  "Use {highlight}openrtl --continue{/highlight} to resume the last session",
  "Use {highlight}openrtl run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}openrtl serve{/highlight} for headless API access to OpenRTL",
  "Use {highlight}openrtl run --attach{/highlight} to connect to a running server",
  "Run {highlight}openrtl upgrade{/highlight} to update to the latest version",
  "Run {highlight}openrtl auth list{/highlight} to see all configured providers",
  "Run {highlight}openrtl agent create{/highlight} for guided agent creation",
  "Use {highlight}/openrtl{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}openrtl github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/openrtl fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}openrtl debug config{/highlight} to troubleshoot configuration",
