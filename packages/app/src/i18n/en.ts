export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenRTL",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenRTL.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "OpenRTL gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenRTL.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenRTL.",
  ...
  "dialog.server.description": "Switch which OpenRTL server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "OpenRTL",
  ...
  "wsl.onboarding.checkingOpencode": "Checking OpenRTL...",
  "wsl.onboarding.checkingOpencodeIn": "Checking OpenRTL in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating OpenRTL...",
  "wsl.onboarding.updatingOpencodeIn": "Updating OpenRTL in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update OpenRTL in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update OpenRTL",
  "wsl.onboarding.opencodeReadyIn": "OpenRTL is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "OpenRTL is ready.",
  "wsl.onboarding.installOpencodeIn": "Install OpenRTL in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install OpenRTL",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "OpenRTL not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before OpenRTL can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "OpenRTL could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen OpenRTL.",
  ...
  "toast.update.description": "A new version of OpenRTL ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenRTL team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenRTL does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenRTL includes free models so you can start immediately.",
  ...
  "app.name.desktop": "OpenRTL Desktop",
  ...
  "settings.desktop.wsl.description": "Run the OpenRTL server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OpenRTL",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how OpenRTL looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenRTL follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenRTL is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenRTL launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenRTL.",
