export const dict = {
  ...
  "dialog.model.unpaid.viewMoreProviders": "Gwelet ouzhpenn 70 pourvezer",
  "dialog.provider.custom.label": "Pourvezer personelaat kenglotus gant OpenAI",
  ...
  "session.header.reveal.containingFolder": "Digeriñ an teuliad endalc'h",
  "session.header.reveal.fileExplorer": "Diskouez en File Explorer",
  "session.header.reveal.finder": "Diskouez e Finder",
